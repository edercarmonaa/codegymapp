...
$router->post('/api/cron/mobile/today-reminder', 'ApiCronController', 'todayReminder', false);
$router->post('/api/cron/mobile/expired-review-reminder', 'ApiCronController', 'expiredReviewReminder', false);
...
$router->get('/api/mobile/notifications', 'ApiMobileController', 'notifications');
...
$router->post('/api/mobile/challenges/reschedule', 'ApiMobileController', 'rescheduleChallenge');
$router->post('/api/mobile/challenges/cancel', 'ApiMobileController', 'cancelChallenge');
...
$router->post('/api/mobile/settings', 'ApiMobileController', 'updateSettings');
$router->post('/api/mobile/settings/sync', 'ApiMobileController', 'updateSettings');
