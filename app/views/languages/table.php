        ...
        <tbody>
            <?php foreach ($languages as $language): ?>
                <tr>
                    ...
                    <td class="text-end">
                        <form class="d-inline" action="<?= $language['is_active'] ? '/api/languages/deactivate' : '/api/languages/activate' ?>" method="post" data-api-form <?= $language['is_active'] ? 'data-confirm="¿Desactivar este lenguaje?"' : '' ?>>
                            <?= csrf_field() ?>
