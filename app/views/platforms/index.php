<div class="d-flex flex-wrap gap-3 align-items-end justify-content-between mb-4">
    ...
    <form class="row g-2 align-items-end" action="/api/platforms/save" method="post" data-api-form data-api-refresh-catalog="platforms">
        <?= csrf_field() ?>
...
<div id="tablePanel" data-catalog-panel="platforms" data-catalog-url="/api/catalogs/platforms/list">
